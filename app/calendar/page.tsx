          ...
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              {family?.googleCalendarId && (
                <a
                  href={`https://calendar.google.com/calendar/u/0/r/month/${new Date().getFullYear()}/${new Date().getMonth() + 1}/${new Date().getDate()}?cid=${family.googleCalendarId}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2 bg-primary-600 text-white rounded-lg text-xs font-medium hover:bg-primary-700 transition-all shadow-sm flex items-center gap-1.5"
                >
