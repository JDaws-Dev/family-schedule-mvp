...
function DashboardContent() {
  ...
  }, [showAddEventModal, selectedEvent, showScanModal, showPhotoUploadModal, showVoiceRecordModal, showAddEventChoiceModal, showActionsModal, showConfirmDialog, showToast]);
    ...
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-0">
          ...
          <PullToRefresh onRefresh={async () => {
            ...
            <div className="flex-1">
              <div className="max-w-2xl mx-auto">
                ...
                {/* TODAY Section - Hero, Always Visible */}
                <TodayEventsCard
                  events={todayEvents || []}
                ...
                {/* ACTION ITEMS Badge/Card - If any RSVPs or actions needed */}
                <ActionItemsCard
                  actionCount={actionRequiredEvents?.length || 0}
                  unconfirmedCount={unconfirmedEvents?.length || 0}
                />

                {/* THIS WEEK Preview - Shows next 3-5 events */}
                <ThisWeekCard
                  events={weekEvents || []}
                  formatTime12Hour={formatTime12Hour}
                  getCategoryEmoji={getCategoryEmoji}
                  formatMomFriendlyDate={formatMomFriendlyDate}
                />

                {/* Quick Add Input - One simple input */}
                <div className="mb-6">
                  <div className="bg-blue-50 rounded-2xl p-5 shadow-md">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Type naturally—we'll handle the rest</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-3 border-2 border-primary-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all text-sm placeholder:text-gray-400 bg-white shadow-sm"
                      ...
                      <button
                        ...
                        className="px-5 py-3 bg-primary-600 text-white rounded-xl font-semibold hover:bg-primary-700 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                      >
                ...
                {/* Bible Verse - Spiritual touchpoint */}
                <div className="mb-20">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-primary-500 rounded-lg p-4 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="text-xl flex-shrink-0">📖</div>
                      <div className="flex-1">
                        <h3 className="text-xs font-semibold text-primary-700 uppercase tracking-wide mb-1.5">
                          Today's Verse
                        </h3>
                        <p className="text-gray-800 italic text-sm mb-1.5 leading-relaxed">
                          "{dailyVerse.text}"
                        </p>
      ...
      {showAddEventChoiceModal && (
        <AddEventChoiceModal
          ...
          onSearchSpecific={() => router.push('/search-emails')}
