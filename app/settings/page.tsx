  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-0">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          {account.gmailPushEnabled ? (
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 border border-green-200 text-green-800 text-xs font-medium rounded">
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-red-50 border border-red-200 text-red-800 text-xs font-medium rounded">
                              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-50 border border-gray-200 text-gray-700 text-xs font-medium rounded">
                              Manual Mode
                            </span>
                          )}
                        </div>
        ...
        {/* Linked Calendars - Browse calendars from schools, sports teams, churches */}
        <div className="bg-white rounded-2xl shadow-soft mb-6">
          <button
            onClick={() => setExpandedSections({...expandedSections, linkedCalendars: !expandedSections.linkedCalendars})}
            className="w-full p-6 border-b border-gray-200 flex items-center justify-between md:cursor-default hover:bg-gray-50 md:hover:bg-white transition-colors"
          >
            <div className="text-left">
          ...
          <div className={`p-6 ${expandedSections.linkedCalendars ? 'block' : 'hidden md:block'}`}>
                          ...
                          <div>
                            ...
                            {calendar.actualCalendarName && (
                              <p className="text-xs text-gray-600 mt-0.5">
                                Calendar: {calendar.actualCalendarName}
                              </p>
                            )}
                      ...
                      <button
                        onClick={async () => {
                          if (window.confirm(`Remove "${calendar.displayName}"?`)) {
                            try {
                              await deleteLinkedCalendar({ calendarId: calendar._id });
                        ...
                        className="ml-3 p-2 text-red-600 hover:bg-red-50 rounded-lg transition min-h-[44px] min-w-[44px]"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition min-h-[56px]"
            >
              + Link a Calendar
            </button>
          </div>
